...
const VALUES: number[] = [6, 4, 7, 5, 3, 1, 2];
      ...
      <CardContent className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button size="sm" className="px-3">Daily</Button>
            <Button size="sm" className="px-3" variant="ghost">Weekly</Button>
          </div>
        </div>
